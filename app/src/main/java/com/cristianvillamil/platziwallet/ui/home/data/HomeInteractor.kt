...
// se encarga de la comunicacion
class HomeInteractor {

    fun retrieveFavoriteTransfersFromCache(responseCallback: HomeContract.OnResponseCallback){
        ...
        // Simular que demore cierto tiempo: 3 seg.
